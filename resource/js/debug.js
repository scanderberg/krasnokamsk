...
$.fn.debugContextMenu = function(method) {
    ...
    return this.each(function() {
        ...
        var showContextMenu = function(e) {
            methods.hide();
            var module = $(this).closest(data.options.moduleWrap).addClass('hover');
        ...
        getContextMenuDiv = function(items, module_wrapper) {
            ...
            if (!$menu.length) {
                ...
                $(this).on('click.debugContext', function(e){e.stopPropagation();});
                $('html').on('click.debugContext', function(e) {
                    methods.hide();
                });
                $('html').on('keypress.debugContext', function(e) {if (e.keyCode == 27 ) methods.hide();} );
            }
...
$(function() 
{
    ...
    $('.debug-hint').tooltip({track:true, delay: 0, showURL: false, extraClass:"debug"});
    ...
    $('.module-wrapper .module-content').each(function() {
        ...
        $.each(keys, function(k, v) {
            ...
            if (v == 'display' && new_val == 'inline') new_val = 'inline-block';
