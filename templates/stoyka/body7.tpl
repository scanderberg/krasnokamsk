...
<br><br>
<img align='bottom' src='{$router->getRootUrl()}templates/stoyka/resource/img/knauf.png' height='30px' /><img align='bottom' src='{$router->getRootUrl()}templates/stoyka/resource/img/knauf.png'  height='30px' /><img align='bottom' src='{$router->getRootUrl()}templates/stoyka/resource/img/knauf.png'  height='30px' />
</div>

<div align='center' class='method-pay'>
<span>Способы оплаты</span>
<br><br>
<img align='bottom' src='{$router->getRootUrl()}templates/stoyka/resource/img/visa_mastercard1.png' height='30px' /><img align='bottom' src='{$router->getRootUrl()}templates/stoyka/resource/img/sberbank.png'  height='30px' /><img align='bottom' src='{$router->getRootUrl()}templates/stoyka/resource/img/alfa.png'  height='30px' />
