...
<img align='bottom' src='{$link}templates/stoyka/resource/img/dostavka2.png' width='100px' />
<br><br>
Быстрая доставка в течении двух дней до Вашего дома!		
</div>		

<div align='center' class='lite1'>
<img align='bottom' src='{$link}templates/stoyka/resource/img/oplata.png' width='100px' />
<br><br>
Различные способы оплаты товара, включая возможность покупки в кредит!		
</div>	

<div align='center' class='lite1'>
<img align='bottom' src='{$link}templates/stoyka/resource/img/skidki.png' width='80px' />
<br><br>
В нашем интернет-магазине действует гибкая система скидок!		
</div>	

<div align='center' class='lite1'>
<img align='bottom' src='{$link}templates/stoyka/resource/img/vozvrat1.png' width='100px' />
<br><br>
Возможность вернуть непонравившийся товар в течении 14 дней		
</div>	
...
<br><br>
<form action='{$link}email.php' method='POST' class='form-subs' id='form-subs' name='form-subs'>
...
<br><br>
<img align='bottom' src='{$link}templates/stoyka/resource/img/knauf.png' height='30px' /><img align='bottom' src='{$link}templates/stoyka/resource/img/knauf.png'  height='30px' /><img align='bottom' src='{$link}templates/stoyka/resource/img/knauf.png'  height='30px' />
</div>

<div align='center' class='method-pay'>
<span>Способы оплаты</span>
<br><br>
<img align='bottom' src='{$link}templates/stoyka/resource/img/visa_mastercard1.png' height='30px' /><img align='bottom' src='{$link}templates/stoyka/resource/img/sberbank.png'  height='30px' /><img align='bottom' src='{$link}templates/stoyka/resource/img/alfa.png'  height='30px' />
...
<a href="{$link}">© 2016 СТРОЙБАЗА-К. Все права защищены.</a>
</div>	
</div>	
