...
<br><br>
<img align='bottom' src='{$router->getRootUrl()}templates/stoyka/resource/img/visa_mastercard1.png' height='30px' /><a href='http://money.yandex.ru/' target='_blank'><img align='bottom' src='{$router->getRootUrl()}templates/stoyka/resource/img/yamoney_button.gif'  height='30px' /></a>
<img align='bottom' src='{$router->getRootUrl()}templates/stoyka/resource/img/qiwi.png'  height='30px' />
<img align='bottom' class='alfaBank' src='{$router->getRootUrl()}templates/stoyka/resource/img/alfa.png'  height='30px' />
<img align='bottom' class='russianStandard' src='{$router->getRootUrl()}templates/stoyka/resource/img/RussianStandardBankR.gif'  height='30px' />
...
<a href="{$router->getRootUrl()}">&copy; 2013 - 2018 СТРОЙБАЗА-К. Все права защищены.</a>
<br><br>
