...
<h1 style='font-size: 20px!important;'>{$category.name}</h1>
<br>
        ...
        <div class="productWrap">
            ...
            <ul class="productList">
                {foreach from=$list item=product}
                    ...
                    <li {$product->getDebugAttributes()} data-id="{$product.id}" class="{if count($imagelist)>1}photoView{/if}{if $product->isOffersUse() || $product->isMultiOffersUse()} showOfferSelect{/if}" {if $category.id == 42} style="height: 370px!important;"{/if}>
                        <div class="hoverBlock">
                            <div class="galleryWrap{if count($imagelist)>4} scrollable{/if}">
                                <a class="control up"></a>
                                <div class="gallery" {if $category.id != 42} style="height: 220px!important;"{/if}>
						...
						{if $category.id == 42}<span style="color: red!important; font-size: 11px!important;">Кирпич продается поддонами!</span>{/if}
...
{/if}
                            ...
                            <div class="info extra" align="center" {if $category.id != 42}  style="height: 60px!important;" {/if}>
								...
								<span>{$product->getCost(3)} {$product->getCurrency()}/кирпич</span>
                                 </div>
