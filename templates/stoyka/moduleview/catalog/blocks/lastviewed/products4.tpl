...
{/if}
                ...
                <li style="{if $smarty.foreach.lastviewed.first}{if $smarty.foreach.lastviewed.total == 4}margin-left: 100px!important;{elseif $smarty.foreach.lastviewed.total == 3}margin-left: 200px!important;{elseif $smarty.foreach.lastviewed.total == 2}margin-left: 300px!important;{elseif $smarty.foreach.lastviewed.total == 1}margin-left: 400px!important;{/if}{/if} width: 200px!important; height: 270px!important; vertical-align: bottom!important;"><a href="{$product->getUrl()}" title="{$product.title}"><img src="{$main_image->getUrl(200,200,'xy')}" alt="{$main_image.title|default:"{$product.title}"}" />
				</a>
