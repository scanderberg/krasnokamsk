...
<div class="light-box" {if $error_fields or $success} style='display: block!important;' {/if} ></div>

<div align='center' class="feedbkForm" id='lids-form' style='display: {if $error_fields or $success}block!important{else}none{/if}; position: absolute!important; z-index: 1000!important;'>
