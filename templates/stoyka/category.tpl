...
<img align="center" src="{$router->getRootUrl()}templates/stoyka/resource/img/calc1.png" /><span class="kirpichCalc">Калькулятор 
кирпича</span>
</a>
...
<img align="center" src="{$router->getRootUrl()}templates/stoyka/resource/img/calc3.png" /><span class="gazobetonCalc">Калькулятор 
газобетона</span>
</a>
