...
$.fn.filesBlock = function(method) {
    ...
    var defaults = {
        ...
        deleteSelected: '.tools-bottom .delete',
        ...
        newFileLineHtml: function() {
            return $('\
                    <tr data-id="{$linked_file.id}" class="item nodrop inqueue">\
                        ...
                        <td class="title"></td>\
                        <td class="description">нет</td>\
                        <td class="size"></td>\
                        <td class="progress"> \
                            <span class="progress-bar"><i class="bar"></i><span class="percent">в очереди</span></span>\
                            <span class="error"></span>\
                        </td>\
                        <td class="actions">\
                            <span class="loader"></span>\
                            <a class="cancel delete">удалить</a>\
                        </td>\
                    </tr>');
        },
