...
<span class="hint" title="{t}Указанный шаблон будет использован вместо блоков. Возможность разметить страницу блоками в этом случае будет отключена. Указывайте произвольный шаблон в случае, если макет невозможно сверстать с помощью gs960.css{/t}">?</span>
<script>
$.allReady(function() {
