<div class="formbox" data-dialog-options='{ "width":"600px" }'>
    <p class="inform-block">Используйте инструмент клонирования для создания собственных тем оформления на основе других. 
    Созданные таким образом темы оформления не изменяются во время обновления системы.</p>
    <form method="POST" action="{urlmake}" enctype="multipart/form-data" class="crud-form">
        <div class="notabs">
            <table class="otable no-td-width" width="100%">
            <tr>
                <td class="otitle" style="width:150px">Исходная тема</td>
