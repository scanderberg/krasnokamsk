...
class FileManager extends \RS\Controller\Admin\Front
{
    ...
    function actionIndex()
    {
        ...
        $helper->setTopToolbar(new Toolbar\Element( array(
            'Items' => array(
                ...
                new ToolbarButton\Button($this->router->getAdminUrl('uploadForm', array('path' => $list['epath']['public_dir'])), t('Загрузить файлы'), array('attr' => array('class' => 'crud-add'))),                
    ...
    function actionUploadForm()
    {
        ...
        $helper
            ...
            ->setBottomToolbar(new Toolbar\Element( array(
                'Items' => array(
                    'save' => new ToolbarButton\SaveForm(null, t('Загрузить'), array('noajax' => true, 'attr' => array('class' => 'saveform start-upload'))),
                    'cancel' => new ToolbarButton\Cancel($this->url->getSavedUrl($this->controller_name.'index')),
                )
            )));
    ...
    function actionCloneTheme()
    {
        ...
        if ($this->url->isPost()) {
            $elem = array(
                ...
                'new_name' => $this->url->post('new_name', TYPE_STRING),
