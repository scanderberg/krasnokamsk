...
$.fn.offer = function(method) {
    ...
    var defaults = {
        ...
        hide             : 'hide',                  //Строка уровнем компл. 
        rowMO            : '.row',                  //Строка уровнем компл. 
        virtualForm      : '.virtual-form',         //Класс виртуальной формы
        virtualSubmit    : '.virtual-form .virtual-submit, .virtual-form button.ok', //Класс элементов отправки виртуальной формы
        ...
        multiDeleteButton : '.tools-bottom .delete', //Кнопка "Удалить" выбранные комплектации
        multiEditButton   : '.tools-bottom .edit'    //Кнопка "Редактировать" выбранные комплектации
    },
    args = arguments;
        ...
        var methods = {
            ...
            */
            showOnlyActualProps: function () {
               ...
               $(data.options.multiOfferWrap+" "+data.options.rowMO+" select", $this).each(function() {
                   if ($('option:not(:disabled):selected', $(this)).length == 0) { 
                   ...
                   $("optgroup",$(this)).each(function(){
                       $(this).toggle( $('option:not(:disabled)', $(this)).length > 0 );
                   });                                   
               });
