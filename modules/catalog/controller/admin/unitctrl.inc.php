    ...
    {  
        ...
        $helper->setTable(new Table\Element(array(
            'Columns' => array(
                    ...
                    new TableType\Text('title', 'Полное название', array('Sortable' => SORTABLE_BOTH, 'href' => $this->router->getAdminPattern('edit', array(':id' => '@id')), 'LinkAttr' => array('class' => 'crud-edit'))),
                    new TableType\Text('stitle', 'Сокращенное название',array('Sortable' => SORTABLE_BOTH)),
