    ...
    {        
        ...
        $helper->setTable(new Table\Element(array(
            'Columns' => array(
                ...
                new TableType\Text('title', 'Название', array('LinkAttr' => array('class' => 'crud-edit'), 'href' => $this->router->getAdminPattern('edit', array(':id' => '@id')), 'Sortable' => SORTABLE_BOTH)),
                new TableType\Text('_type_text', 'Тип'),
