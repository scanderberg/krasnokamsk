    ...
    function helperIndex()
    {
        ...
        $helper->setTable(new Table\Element(array(
            'Columns' => array(
                ...
                new TableType\Text('name', 'Название', array(
                    'href' => $this->router->getAdminPattern('edit', array(':mod' => '@class'))
                )),
                new TableType\Text('description', 'Описание'),
                new TableType\Text('version', 'Версия', array('TdAttr' => array('class'=> 'cell-small'))),                
                new TableType\Usertpl('enabled', 'Включен', '%modcontrol%/col_enabled.tpl'),
                new TableType\Text('class', 'Идентификатор', array('ThAttr' => array('width' => '50'))),
            ...
            'container' => new Filter\Container( array( 
                                'lines' =>  array(
                                    new Filter\Line( array('items' => array(
                                                            new Filter\Type\Text('name','Название'),
                                                            new Filter\Type\Text('class','Идентификатор'))
                                                        )
                                    ))
                                )
                            ))
