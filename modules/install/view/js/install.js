                ...
                var installStart = function() {
                        ...
                        var executeProcess = function(first) {
                            ...
                            $.post( $(this).data('href'), data, function(response) {
                                ...
                                setProgressError([{moduleTitle:"Ошибка", message: "Сервер вернул некорректные данные. Пожалуйста, обратитесь к разработчику."}]);
                            });
                        };
