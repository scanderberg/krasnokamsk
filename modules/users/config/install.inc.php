    ...
    function install()
    {
        ...
        if ($result) {
            ...
            $group->getFromArray(array(
                ...
                'name' => 'Супервизоры',
                'description' => 'Пользователь имеющий доступ абсолютно всегда ко всем  модулям и сайтам',
                'is_admin' => 1
            ))->insert();
            ...
            $group->getFromArray(array(
                ...
                'name' => 'Администраторы',
                'description' => 'Пользователи, имеющие права на удаление, добавление, изменение контента',
                'is_admin' => 1
            ))->insert();
