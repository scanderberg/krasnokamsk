...
class Ctrlgroup extends \RS\Controller\Admin\Crud
{
    ...
    function helperIndex()
    {
        ...
        $helper->setTable(new Table\Element(array(
            'Columns' => array(
                ...
                new TableType\Text('name', 'Название', array('href' => $this->router->getAdminPattern('edit', array(':id' => '@alias')), 'Sortable' => SORTABLE_BOTH)),
                new TableType\Text('description', 'Описание'),
                new TableType\Text('alias', 'Псевдоним', array('ThAttr' => array('width' => '50'), 'Sortable' => SORTABLE_BOTH, 'CurrentSort' => SORTABLE_ASC)),                
    ...
    function actionAdd($primaryKeyValue = null, $returnOnSuccess = false, $helper = null)
    {
        ...
        'Columns' => array(
            new TableType\Text('class', 'Модуль', array('TdAttr' => array('align' => 'center'))),
            new TableType\Text('name', 'Название'),
            new TableType\Text('description', 'Описание'),
        ...
        $admin_tree = new \RS\Html\Tree\Element(array(
                ...
                'sortIdField' => 'alias',
                'activeField' => 'alias',
                'mainColumn' => new TableType\Text('title', 'Название', array()),
