    ...
    function actionIndex()
    {
        ...
        if (!$this->url->isAjax()) {
            ...
            $this->app
                ...
                ->addJs('ui.jquery.all.min.js',null, BP_COMMON)
                ->addJs('jquery.datetimeaddon.min.js',null, BP_COMMON)
                ->addJs('lab.min.js', null, BP_COMMON)            
                ->addJs('jquery.form.js', null, BP_COMMON)
                ->addJs('jquery.cookie.js', null, BP_COMMON)
                ->addJs( 'admindebug.js')
                ->addJs( 'admin.js')
                ->addJs('updatable.js', null, BP_COMMON)
                ->addJs('coreobject.js', null, BP_COMMON)
                ->addJs( 'tabs.js','tabs')
                ->addJs( 'jquery.tooltip.js','tooltip')
                ->meta
