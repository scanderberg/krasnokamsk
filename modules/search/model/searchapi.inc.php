    ...
    public static function currentEngine()
    {
        if (self::$current_engine === null) {
            ...
            if (class_exists($service_class)) {
                ...
                throw new Exception(t('Не найден класс поискового сервиса %0', array($service_class)));
            }
        }
    ...
    public static function getEngines()
    {
        ...
        foreach ($event_result->getResult() as $service) {
            if ($service instanceof \Search\Model\Engine\AbstractEngine) {
                ...
                throw new Exception(t('Поисковый сервис должен имплементировать интерфейс \Search\Model\Engine\AbstractEngine'));
            }
        }
        return $result;
    }
